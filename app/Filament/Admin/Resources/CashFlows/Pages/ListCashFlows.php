...
namespace App\Filament\Admin\Resources\CashFlows\Pages;

use App\Enums\Merchants\MerchantType;
use App\Filament\Admin\Resources\CashFlows\CashFlowResource;
...
class ListCashFlows extends ListRecords
{
    ...
    protected ?string $subheading = 'Daftar pemasukan dan pengeluaran gudang atau merchant';
        ...
        return [
            Actions\CreateAction::make()
                ...
                ->using(function (array $data): CashFlow {
                    $merchant = Merchant::query()->find($data['merchant_id'] ?? null);
