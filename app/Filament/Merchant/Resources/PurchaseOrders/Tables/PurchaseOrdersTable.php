...
namespace App\Filament\Merchant\Resources\PurchaseOrders\Tables;
...
use App\Filament\Merchant\Resources\PurchaseOrders\Actions\ClosePurchaseOrderAction;
...
class PurchaseOrdersTable
{
    public static function configure(Table $table): Table
    {
        return $table
            ...
            ->description('Daftar purchase order dari supplier')
            ->columns([
                TextColumn::make('id')
                    ->label('No')
                    ->rowIndex()
