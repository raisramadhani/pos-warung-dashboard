{{-- Sidebar Navigation Confirmation --}}
<div id="sidebar-nav-confirm-modal"
    ...
    <div
        ...
        <div class="p-5 flex flex-col items-center text-center gap-3">
            ...
            <div>
                <h3 class="font-bold text-sm text-gray-800 dark:text-white">Tinggalkan Halaman Kasir?</h3>
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Pesanan yang sedang berjalan dan koneksi
                    printer akan terputus.</p>
            </div>
        </div>
        <div class="p-3 border-t border-gray-100 dark:border-gray-700 flex gap-2">
            <button onclick="closeModal('sidebar-nav-confirm-modal')"
            ...
            <button onclick="confirmSidebarNavProceed()"
