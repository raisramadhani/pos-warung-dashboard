    ...
    public function run(): void
    {
        ...
        $flowsByMerchant = [
            'SOLO 1' => [
                ...
                ['type' => CashFlowType::Expense, 'description' => 'Pembelian bahan kemasan', 'amount' => 450000, 'transaction_date' => '2026-03-05'],
            ],
            'SOLO 2' => [
            ...
            'SOLO 3' => [
                ...
                ['type' => CashFlowType::Expense, 'description' => 'Perbaikan mesin produksi', 'amount' => 600000, 'transaction_date' => '2026-02-20'],
