...
- Asks the agent to commit finished work ("commitkan") and delegates commit mechanics to it — staging, message wording, and execution — rather than committing or dictating steps himself. Confidence: 0.8
