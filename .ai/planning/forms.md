...
| morphTo             | `MorphToSelect`    | https://filamentphp.com/docs/5.x/forms/morph-to-select  |
...
**Unique fields in v4**: Use `unique` without `ignoreRecord`. Filament v5
automatically ignores the current record when editing:
